          ...
          <div className="space-y-4">
            ...
            {savedViews.length === 0 ? (
              ...
              <div className="space-y-2">
                {savedViews.map((view) => (
                  <div key={view.id} className="bg-accent border border-border/10 rounded-xl p-3">
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-background/40 border border-border/10 rounded-lg focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 text-foreground placeholder-muted-foreground outline-none transition-all"
                />
              </div>
      ...
      case "view-sensors":
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              {/* View Mode Toggle */}
              <div className="p-3 bg-accent rounded-xl border border-border/10">
                <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center justify-between p-3 bg-accent rounded-xl border border-border/10">
                <div>
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition-all duration-300 ${
                    sensorsVisible 
                      ...
                      : 'bg-accent text-muted-foreground border border-border/10 hover:bg-accent'
                  }`}
                >
              ...
              <div className="space-y-2">
                {(() => {
                  ...
                  return order.filter(d => groups[d]?.length).map((d) => (
                    <div key={d} className="border border-border/10 rounded-xl overflow-hidden">
                      <div className="px-3 py-2 bg-accent flex items-center justify-between">
    ...
    <div className="w-80 bg-card/80 backdrop-blur-xl border-l border-border/5 shadow-[-10px_0_30px_rgba(0,0,0,0.3)] flex flex-col h-full min-h-0 relative z-10">
      ...
      <div className="p-4 border-b border-border/5 bg-foreground/[0.02] flex flex-col items-center">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 text-muted-foreground hover:text-foreground hover:bg-accent rounded-lg transition-all duration-300 w-full justify-center"
        >
