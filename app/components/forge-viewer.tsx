    ...
    return (
      <div className="forge-viewer-error">
        ...
        <div className="mt-4 space-y-2">
          <button onClick={() => window.location.reload()} className="mr-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded">
            Refresh Page
          </button>
          <button onClick={() => setError(null)} className="px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded">
            Try Again
          </button>
        </div>
      </div>
