...
| ----------------------------------------------------------------- | ------------------------------------------------ |
| [Architecture Index](./README.md)                                  | Index of all architecture documents               |
| [Backend API Reference](./BACKEND_API_REFERENCE.md)                | Complete API endpoint documentation               |
| [Database Architecture](./DATABASE_ARCHITECTURE.md)                | MongoDB collections, models, and relationships    |
| [Frontend Architecture](./FRONTEND_ARCHITECTURE.md)                | Pages, components, state management               |
| [Infrastructure & DevOps](./INFRASTRUCTURE_AND_DEVOPS.md)          | Deployment, hosting, CI/CD, scripts               |
| [Authentication & Security](./AUTHENTICATION_AND_SECURITY.md)      | Auth providers, RBAC, security analysis           |
